<aside
    ...
    <div class="sidenav-header">
        ...
        <div class="border-0 d-flex align-items-center px-0 mt-3">
            ...
            } elseif ("Guidance Counselor" == $_SESSION['role']) {
    ...
    <div class="collapse navbar-collapse  w-auto max-height-vh-90" id="sidenav-collapse-main">
        ...
        <a class="nav-link  " href="../accounting/list.accounting.php">
            ...
            <a class="nav-link  " href="../guidance/list.guidance.php">
                ...
                <span class="nav-link-text ms-1">Guidance Counselors List</span>
            </a>
        </li>
...
<li class="nav-item">
            ...
            ';
            } else if ($_SESSION['role'] == "Guidance Counselor") {
                echo '
            <li class="nav-item">
                <a class="nav-link  active" href="../dashboard/index.php">
                    <div
                        class="icon icon-shape icon-sm shadow bo`rder-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg width="12px" height="12px" viewBox="0 0 45 40" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
    ...
    <div class="sidenav-footer mx-3">
        ...
        elseif ($_SESSION['role'] == "Dean") {
            ...
            echo '
            <a class="btn bg-gradient-light mt-2 mb-3  border-radius-md mx-3" href="../guidance/edit.guidance.php" data-bs-toggle="tooltip"
            data-bs-placement="top" title="Edit Account" data-container="body" data-animation="true"><i
                class="fas fa-user-edit"></i></a>';
        } elseif ("Admission" == $_SESSION['role']) {
